...
- 2026-05-22 party-list/chat low-scale marker guard: `U+E031`, `U+E037`, and `U+E0E1`-`U+E0E8` must be isolated clean PUA cells with 8px base/mip texture neighborhoods. Do not reuse dirty target cells for these glyphs.
