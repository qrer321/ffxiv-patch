...
- 2026-05-31 17:33 recheck: the quick applied drift gate still passes against installed `D:\...\game`, and `Scripts\check-hd-crash-logs.ps1 -FailOnAnyNewCrash` finds no `AtkFontAnalyzerRenderer` appcrash newer than the `2026-05-31 01:08:12` release build.
