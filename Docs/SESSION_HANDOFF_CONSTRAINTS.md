...
- 2026-05-29 current release rebuild evidence: after commit `7fcf572`, `Scripts\build-release.ps1` rebuilt `Release\Public\FFXIVKoreanPatch.exe` at `2026-05-29 22:51:37`; SHA256 remains `93E628E63E5803B1993B4F60FDEA46C09E94251CF9C60B40E42BFB6B32462BCC`. Full `Scripts\verify-hd-crash-release.ps1` regenerated `.tmp\release-hd-crash-head-ja` and passed focused HD crash checks, known-bad rejection, and the post-release crash-log check. Current logs are `.tmp\applied-route-verification-logs\20260529-225238-generator.log` and `.tmp\applied-route-verification-logs\20260529-225238-verifier.log`.
