        ...
        private sealed partial class Verifier
        {
            private VerificationStep[] CreateVerificationSteps()
            {
                return new VerificationStep[]
                {
                    ...
                    new VerificationStep("ingame-font-scale-survey", VerifyInGameFontScaleSurvey),
                    new VerificationStep("ingame-font-scale-routes", VerifyInGameFontScaleRoutes),
                    new VerificationStep("party-bonus-font-scale", VerifyPartyBonusFontScale),
