        ...
        private sealed partial class Verifier
        {
            private VerificationStep[] CreateVerificationSteps()
            {
                return new VerificationStep[]
                {
                    ...
                    new VerificationStep("lobby-full-coverage-capacity", VerifyLobbyFullCoverageCapacity),
                    new VerificationStep("lobby-page-split-capacity", VerifyLobbyPageSplitCapacity),
                    ...
                    new VerificationStep("lobby-texture-cell-margin", VerifyLobbyTextureCellMargin),
                    new VerificationStep("lobby-runtime-font-safety", VerifyLobbyRuntimeFontSafety),
                    new VerificationStep("fdt-table-invariants", VerifyFdtTableInvariants),
                    ...
                    new VerificationStep("start-screen-glyph-variants", VerifyStartScreenGlyphVariantRows),
                    ...
                    new VerificationStep("lobby-runtime-scale-font-routes", VerifyLobbyRuntimeScaleFontRoutes),
