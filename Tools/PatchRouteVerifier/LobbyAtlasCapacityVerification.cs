    ...
    internal static partial class PatchRouteVerifier
    {
        private sealed partial class Verifier
        {
            ...
            private void VerifyLobbyAtlasCapacity()
            {
                ...
                LobbyAtlasCapacityStats stats = WriteLobbyAtlasCapacityReports(requirements, reportDir);

                Pass(
                    "lobby atlas capacity wrote {0} target fonts, {1} required codepoints, {2} missing target glyphs, {3} source-covered glyphs, {4} aggregate allocation failures",
                    stats.TargetFonts,
