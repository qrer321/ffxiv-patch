...
- 원문 유지 선택
  ...
  - 기술명
  - 상용구
  - 임무명 (`ContentFinderCondition`의 임무명/짧은 임무명)
- 사전 점검
- 전체 한글 패치
- 한글 폰트 패치
- 한글 패치 제거
